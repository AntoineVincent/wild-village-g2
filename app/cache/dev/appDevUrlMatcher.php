...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // wild_village_homepage
        if (rtrim($pathinfo, '/') === '') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'wild_village_homepage');
            }

            return array (  '_controller' => 'wildVillageBundle\\Controller\\DefaultController::indexAction',  '_route' => 'wild_village_homepage',);
        }
        ...
        if (0 === strpos($pathinfo, '/user')) {
            ...
            // user_espacemodif
            if ($pathinfo === '/user/espacemodif') {
                return array (  '_controller' => 'AppBundle\\Controller\\EspacemodifController::espacemodifAction',  '_route' => 'user_espacemodif',);
            }

            // user_search
            if ($pathinfo === '/user/search') {
                return array (  '_controller' => 'AppBundle\\Controller\\DefaultController::searchAction',  '_route' => 'user_search',);
            }
