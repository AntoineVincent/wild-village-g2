 ...
 */
class datauser extends \AppBundle\Entity\datauser implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\datauser' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\datauser' . "\0" . 'age', '' . "\0" . 'AppBundle\\Entity\\datauser' . "\0" . 'iduser'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (datauser $proxy) {
